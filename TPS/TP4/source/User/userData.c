...
static User user_array[MAX_USER_COUNT] = {{"11111111", "11111", 1, {4, 5, 0, 9, 7, 9, 0, 2, 1, 5, 3, 3, 0, 0, 5, 5, 99, 99, 99}},
		                                 {"12345678" , "1234" , 1, {4, 5, 1, 7, 6, 6, 0, 1, 3, 0, 7, 5, 9, 0, 8, 6, 99, 99, 99}},
		                                 {"99999999",  "99999", 2, {4, 5, 4, 0, 7, 5, 0, 0, 7, 1, 5,8 , 0, 0, 8, 7, 99, 99, 99}},
									     {"77777777",  "7777",  2, {4, 5, 1, 7, 6, 6, 0, 1, 3, 0, 7, 5, 9, 0, 8, 6, 99, 99, 99}},
										 {"10101010",  "10101", 3, {5, 5, 4, 7, 3, 0, 0, 9, 5, 1, 7, 2, 7, 9, 9, 2, 99, 99, 99}},
										 {"66666666",  "66666", 3, {4, 1, 1, 1, 9, 7, 2, 7, 2, 4, 4, 1, 8, 8, 8, 2, 99, 99, 99}}};
