...
static colors_t Image_Matrix_5[VUMETER_HEIGHT * NUMBER_OF_BANDS]=
		{
				...
				YELLOW,YELLOW,RED,RED,RED,RED,YELLOW,BLUE,
				YELLOW,YELLOW,RED,YELLOW,YELLOW,YELLOW,YELLOW,BLUE,
				YELLOW,YELLOW,RED,RED,RED,RED,YELLOW,BLUE,
				YELLOW,YELLOW,YELLOW,YELLOW,YELLOW,RED,YELLOW,BLUE,
				YELLOW,YELLOW,YELLOW,YELLOW,YELLOW,RED,YELLOW,BLUE,
				YELLOW,YELLOW,RED,RED,RED,RED,YELLOW,BLUE,
				YELLOW,YELLOW,YELLOW,YELLOW,YELLOW,YELLOW,YELLOW,BLUE,
		};
static colors_t Image_Matrix_5[VUMETER_HEIGHT * NUMBER_OF_BANDS]=
		{
				...
				BLUE,BLUE,BLUE,BLUE,BLUE,BLUE,BLUE,BLUE,
				GREEN,YELLOW,RED,YELLOW,YELLOW,YELLOW,YELLOW,BLUE,
				GREEN,YELLOW,RED,RED,RED,RED,YELLOW,BLUE,
				YELLOW,YELLOW,YELLOW,YELLOW,YELLOW,RED,YELLOW,BLUE,
				YELLOW,YELLOW,YELLOW,YELLOW,YELLOW,RED,YELLOW,BLUE,
				YELLOW,YELLOW,RED,RED,RED,RED,YELLOW,BLUE,
				YELLOW,YELLOW,YELLOW,YELLOW,YELLOW,YELLOW,YELLOW,BLUE,
